...
build:
	@echo "Building pocketcasts-to-markdown..."
	@CGO_ENABLED=1 go build -ldflags "$(LDFLAGS)" -o pocketcasts-to-markdown .
	@echo "✅ Built: pocketcasts-to-markdown"
